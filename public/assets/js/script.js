    ...
    $('#contactForm').submit(function(){ 
	             ...
	             $.ajax({
						...
						success: function(msg){ 
							if(msg.status==200){
								$("#formresulttxt").html('<div class="text-success">'+msg.message+'</div>');
							 }else{
                                $("#formresulttxt").html('<div class="text-danger">'+msg.message+'</div>');
							 }
							},
						error: function(msg){
							$("#formresulttxt").html('<div class="text-danger">Internal error found</div>');						
						}
					});
        ...
        $('#contactFormquick').submit(function(){ 

            $.ajax({
                   type: "POST",
                   url: "./assets/php/form-process-quick.php",
                   data: new FormData(this),
                   dataType: "json",
                   contentType: false,
                   cache: false,
                   ...
                   success: function(msg){ 
                       if(msg.status==200){
                           $("#formresultquick").html('<div class="text-success">'+msg.message+'</div>');
                        }else{
                           $("#formresultquick").html('<div class="text-danger">'+msg.message+'</div>');
                        }
                       },
                   error: function(msg){
                       $("#formresultquick").html('<div class="text-danger">Internal error found</div>');						
                   }
               });
